...
from LEGENDX import CMD_LIST, LOAD_PLUG, bot
import glob
import sys
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"LEGENDX/modules/{shortname}.py")
        name = "LEGENDX.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["LEGENDX.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "LEGENDX/modules/*.py"
